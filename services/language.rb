module Language
  ...
  TEXTS = {
    en: {
      ...
      empty_database: 'Unfortunately, this database is empty at the moment.',
      type: 'Please enter '
    },
    ru: {
      ...
      empty_database: 'К сожалению, в этой базе нет данных на текущий момент.',
      type: 'Плжалуйста введите '
    }
  }.freeze
