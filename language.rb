...
# Explanation/Description Language module
module Language
  @@language = :en
  ...
  TEXTS = {
    ...
    ru: {
      ...
      book_info: 'По данному автору доступна следующая кнtextsига:',
      confirm_payment: 'Введите "Купить" чтобы купить книгу или любой другой символ чтобы выбрать другого автора',
