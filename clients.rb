...
# Description/Explanation of Clients class
class Clients < Rating
  ...
  def set_client_info
    ...
    client = set_new_client_info while client.nil?
    client
  end
  ...
  def order_creation(client, located_book)
    ...
    hash_of_order = {
      'book_id' => located_book['id'].to_s,
      'created_at' => time_real,
      'client_id' => client['id'].to_i.to_s,
      'payed' => located_book['price'].to_s
    }
